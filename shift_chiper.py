...
print("Plain text tidak dapat terenkripsi dikarenakan key = 44 (ketentuan soal menggunakan key = 2 digit nim terakhir)")
# plain text tidak dapat terenkripsi dikarenakan key=44 (2 digit nim terakhir)
